...
function pathfinding.fill_waypoints(gameobject, target_x, target_y)
    ...
    repeat pathfinding.single_astar_step(gameobject, target_x, target_y) until #closed_nodes >
        1000000 or #open_nodes < 1 or #gameobject.waypoints > 0
end
...
function pathfinding.single_astar_step(gameobject, target_x, target_y)
    ...
    local direct_neighbors = pathfinding.get_direct_neighbor_tile_indexes(
                                 closed_nodes[i_cur_tile].i_tile,
    ...
    for i = 1, #neighboring_nodes, 1 do
        ...
        neighboring_nodes[i]["hcost"] = pathfinding.distance_between_points(
                                            map.background_tiles[neighboring_nodes[i]
                                                .i_tile].left +
                                                (map.tile_width / 2),
                                            map.background_tiles[neighboring_nodes[i]
                                                .i_tile].top +
        ...
        neighboring_nodes[i]["gcost"] = pathfinding.distance_between_points(
                                            ...
                                            map.background_tiles[neighboring_nodes[i]
                                                .i_tile].top +
                                                (map.tile_height / 2),
                                            map.background_tiles[closed_nodes[i_cur_tile]
                                                .i_tile].left +
                                                (map.tile_width / 2),
                                            map.background_tiles[closed_nodes[i_cur_tile]
                                                .i_tile].top +
